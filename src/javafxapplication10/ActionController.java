...
public class ActionController implements Initializable {
    ...
    private void buttonclicked(ActionEvent event) {
        ...
        {
            // add game name
            c.cartGames.add("Devil May Cry 5");
            // add game price
            c.prices.add(170);
        ...
        {
            // add game name
            c.cartGames.add("Mortal Kombat 11");
            // add game price
            c.prices.add(125);
