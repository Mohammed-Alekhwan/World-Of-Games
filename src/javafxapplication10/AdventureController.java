...
public class AdventureController implements Initializable {
    ...
    private void buttonClicked(ActionEvent event) {
        ...
        {
            // add game name
            c.cartGames.add("Red Dead Redamtion 2");
            // add game price
            c.prices.add(179);
        ...
        {
            // add game name
            c.cartGames.add("The Walking Dead");
            // add game price
            c.prices.add(75);
        ...
        {
            // add game name
            c.cartGames.add("Star Wars Jedi: Fallen Order");
            // add game price
            c.prices.add(159);
        ...
        {
            // add game name
            c.cartGames.add("Death Stranding");
            // add game price
            c.prices.add(149);
        ...
        {
            // add game name
            c.cartGames.add("Horizon Zero Dawn");
            // add game price
            c.prices.add(119);
    ...
    @FXML
    private void toSiulation(MouseEvent event) throws IOException {
