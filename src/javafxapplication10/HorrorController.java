...
public class HorrorController implements Initializable {
    ...
    private void buttonClicked(ActionEvent event) {
        ...
        {
            // add game name
            c.cartGames.add("Resident Evil Village");
            // add game price
            c.prices.add(160);
        ...
        {
            // add game name
            c.cartGames.add("Little Nightmares 2");
            // add game price
            c.prices.add(140);
        ...
        {
            // add game name
            c.cartGames.add("Amnesia Rebirth");
            // add game price
            c.prices.add(70);
        ...
        {
            // add game name
            c.cartGames.add("Dead By Daylight");
            // add game price
            c.prices.add(90);
        ...
        {
            // add game name
            c.cartGames.add("Among The sleep");
            // add game price
            c.prices.add(50);
        ...
        {
            // add game name
            c.cartGames.add("Friday The 13th");
            // add game price
            c.prices.add(45);
