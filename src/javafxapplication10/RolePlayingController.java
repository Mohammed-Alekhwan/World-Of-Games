 ...
 * @author klooo
 */
public class RolePlayingController implements Initializable {
    ...
    private void buttonClicked(ActionEvent event) {
        ...
        {
            // add game name
            c.cartGames.add("Dark Souls III");
            // add game price
            c.prices.add(89);
        ...
        {
            // add game name
            c.cartGames.add("Yakuza Like a Dragon");
            // add game price
            c.prices.add(170);
        ...
        {
            // add game name
            c.cartGames.add("Mass Effect Andromeda");
            // add game price
            c.prices.add(70);
        ...
        {
            // add game name
            c.cartGames.add("Divinity: Original Sin 2");
            // add game price
            c.prices.add(50);
        ...
        {
            // add game name
            c.cartGames.add("Kingdom Hearts III");
            // add game price
            c.prices.add(119);
    ...
    @FXML
    private void toStrategey(MouseEvent event)throws IOException{
    ...
    @FXML
    private void toSport(MouseEvent event) throws IOException{
