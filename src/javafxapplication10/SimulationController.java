...
public class SimulationController implements Initializable {
    ...
    private void buttonClicked(ActionEvent event) {
        ...
        {
            // add game name
            c.cartGames.add("Train Sim World 2");
            // add game price
            c.prices.add(40);
        ...
        {
            // add game name
            c.cartGames.add("Dirt Rally 2.0");
            // add game price
            c.prices.add(89);
        ...
        {
            // add game name
            c.cartGames.add("Railway Empire");
            // add game price
            c.prices.add(75);
        ...
        {
            // add game name
            c.cartGames.add("Surviving Mars");
            // add game price
            c.prices.add(70);
        ...
        {
            // add game name
            c.cartGames.add("Farming Simulator 22");
            // add game price
            c.prices.add(160);
        ...
        {
            // add game name
            c.cartGames.add("Stardew Valley");
            // add game price
            c.prices.add(40);
    ...
    @FXML
    private void toStrtegy(MouseEvent event)throws IOException{
