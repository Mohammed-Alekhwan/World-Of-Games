...
public class SportsController implements Initializable {
    ...
    private void buttonClicked(ActionEvent event) {
        ...
        {
            // add game name
            c.cartGames.add("Captain Tsubasa");
            // add game price
            c.prices.add(140);
        ...
        {
            // add game name
            c.cartGames.add("Tony Hawk's Pro Skater");
            // add game price
            c.prices.add(130);
        ...
        {
            // add game name
            c.cartGames.add("MLB The Show 21 ");
            // add game price
            c.prices.add(150);
