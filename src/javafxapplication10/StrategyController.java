...
public class StrategyController implements Initializable {
    ...
    private void buttonClicked(ActionEvent event) {
        ...
        {
            // add game name
            c.cartGames.add("XCOM 2 Collection");
            // add game price
            c.prices.add(80);
        ...
        {
            // add game name
            c.cartGames.add("Civilization VI ");
            // add game price
            c.prices.add(40);
        ...
        {
            // add game name
            c.cartGames.add("Valkyria Chronicles 4");
            // add game price
            c.prices.add(110);
        ...
        {
            // add game name
            c.cartGames.add("Stellaris Deluxe Edition");
            // add game price
            c.prices.add(160);
        ...
        {
            // add game name
            c.cartGames.add("Age of Wonders: Planetfall");
            // add game price
            c.prices.add(130);
